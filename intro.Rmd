...
- Matrices can be created from other vectors or matrices using `cbind()`
or `rbind()` 
- If elements are shorter than required, they will be recycled (whenever possible)
...
y    8    9   10    8
Warning message:
In rbind(x, y) : number of columns of result is not a multiple of 
vector length (arg 2)
```
